...
namespace AmpPwaApps.Models
{
    ...
    {
        public string OpeningstijdMaandag { get; set; }
        public string SluitingstijdMaandag { get; set; }
        public string OpeningstijdDinsdag { get; set; }
        public string SluitingstijdDinsdag { get; set; }
        public string OpeningstijdWoensdag { get; set; }
        public string SluitingstijdWoensdag { get; set; }
        public string OpeningstijdDonderdag { get; set; }
        public string SluitingstijdDonderdag { get; set; }
        public string OpeningstijdVrijdag { get; set; }
        public string SluitingstijdVrijdag { get; set; }
        public string OpeningstijdZaterdag { get; set; }
        public string SluitingstijdZaterdag { get; set; }
        public string OpeningstijdZondag { get; set; }
        public string SluitingstijdZondag { get; set; }
    }
    ...
    public class Openingstijden
    {
        ...
        public Werkplaats Werkplaats { get; set; }
        public string SpecialeOpeningstijden { get; set; }
    }

    public class Properties
    {
        public string Dealernummer { get; set; }
        public string Dealernaam { get; set; }
        public string Vestigingnummer { get; set; }
        public string Internetnaam { get; set; }
        public string Handelsnaam { get; set; }
        public string Soortvestiging { get; set; }
        ...
        public string EmailWerkplaats { get; set; }
        public string URLdealermerkensite { get; set; }
        public string URLdealersite { get; set; }
        public string WerkplaatsafspraakURL { get; set; }
        public string EmailadresBeheerderDealermerkensite { get; set; }
        public List<string> Licenties { get; set; }
        public List<object> Services { get; set; }
        public Openingstijden Openingstijden { get; set; }
        public string LatLong { get; set; }
        public string Afstand { get; set; }
        public List<object> RayonDealerLicenties { get; set; }
    }
